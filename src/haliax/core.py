...
class NamedArray:
    ...
    # Deprecated overload
    @typing.overload
    def dot(self, axis: Optional[AxisSelection], *b, precision: PrecisionLike = None) -> "NamedArray":
        ...

    @typing.overload
    def dot(self, *args, axis: Optional[AxisSelection], precision: PrecisionLike = None) -> "NamedArray":
        ...
